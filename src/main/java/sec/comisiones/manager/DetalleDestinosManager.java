...
public class DetalleDestinosManager {
	private DetalleDestinosDAO c = new DetalleDestinosDAO();
	private BeanContainer<Integer, DetalleDestinos> sc = null;

	public Table cargaTabla(int idComision){
		
		sc=c.getAllDetalleDestinosContainer(idComision);
	   ...
	   //Establecemos el tamaño de Grid
	    ...
	    table.setVisibleColumns(new Object[] {"descLocalidad","descProvincia"});
		table.setColumnHeaders(new String[]  {"Localidad", "Provincia"});
