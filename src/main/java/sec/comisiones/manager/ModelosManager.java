...
public class ModelosManager {
	private ModelosDAO c = new ModelosDAO();
	private BeanContainer<Integer, Modelos> sc = null;


	public Table cargaTabla(){
		
		sc=c.getAllModelosContainer();
	   ...
	   //Establecemos el tama�o de Grid
		...
		table.setVisibleColumns(new Object[] {"id", "nombre", "descripcion", "descMarca"});
		table.setColumnHeaders(new String[]  {"Id", "Código", "Descripción", "Marca"});
