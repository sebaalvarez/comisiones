...
import sec.comisiones.manager.EstadosManager;
...
public class EstadosForm extends CustomComponent {

	private VerticalLayout mainLayout;
	private Panel contenedorPanel;
	private VerticalLayout verticalLayout_1;
	final EstadosManager tblUser = new EstadosManager();
	private Table tb;
	...
	public EstadosForm(Usuarios usr) {
		usrLog= usr;
		ini();
	}
...
///////////////////////////////////////////////	
	...
	//        binder.bindMemberFields(this);
	    ...
	    //	btnModifica.setDescription("Guarda Modificaciones");
	    	...
	    	nombre.addValidator(new StringLengthValidator("Longitud Máxima 15 caracteres", 0, 20, true));
	        ...
	        btnElimina.addClickListener(new ClickListener(){
				...
				/*	
					...
					if (u.existenRegistrosRelacionados(nombre.getValue())==0) {
						ConfirmDialog.show(getUI(), "Confirmar", "�Desea eliminar el registro seleccionado?","S�", "No", new ConfirmDialog.Listener() {
