...
import sec.comisiones.manager.CategoriasManager;
...
public class CategoriasForm extends CustomComponent {

	private VerticalLayout mainLayout;
	private Panel contenedorPanel;
	private VerticalLayout verticalLayout_1;
	final CategoriasManager tblUser = new CategoriasManager();
	private Table tb;
	...
	public CategoriasForm(Usuarios usr) {
		usrLog= usr;
		ini();
	}
	...
	private void ini(){
		...
		btnNew.addClickListener(new ClickListener(){
			public void buttonClick(ClickEvent event) {
				...
				CategoriasDAO ud=new CategoriasDAO();
...
///////////////////////////////////////////////	
	...
	class MyForm extends FormLayout {
	    ...
	    TextField montoProvincial = new TextField("monto Provincial$");
	    TextField montoNacional = new TextField("monto Nacional$");
	    TextField montoInternacional = new TextField("monto Internacional$");
	    ...
	    HorizontalLayout hl_0= new HorizontalLayout(montoProvincial,montoNacional,montoInternacional);
	    ...
	    public void setItemDataSource(Item item) {
	        addComponents(nombre, descripcion, hl_0, hl_1);
	...
	//        binder.bindMemberFields(this);
	    ...
	    //	btnModifica.setDescription("Guarda Modificaciones");
	    	...
	    	montoProvincial.addStyleName("Small");
	    	montoProvincial.setRequired(true);
	    	montoProvincial.setRequiredError("Campo Obligatorio");
	    	montoProvincial.addValidator(new FloatRangeValidator("Rango Permitido [0,0 - 5.000,0]",0.0f,5000.0f));
	    	montoProvincial.setImmediate(true);
	    	montoProvincial.setValidationVisible(true);

	    	montoNacional.addStyleName("Small");
	    	montoNacional.setRequired(true);
	    	montoNacional.setRequiredError("Campo Obligatorio");
	    	montoNacional.addValidator(new FloatRangeValidator("Rango Permitido [0,0 - 5.000,0]",0.0f,5000.0f));
	    	montoNacional.setImmediate(true);
	    	montoNacional.setValidationVisible(true);
	    	
	    	montoInternacional.addStyleName("Small");
	    	montoInternacional.setRequired(true);
	    	montoInternacional.setRequiredError("Campo Obligatorio");
	    	montoInternacional.addValidator(new FloatRangeValidator("Rango Permitido [0,0 - 5.000,0]",0.0f,5000.0f));
	    	montoInternacional.setImmediate(true);
	    	montoInternacional.setValidationVisible(true);
	    	...
	    	if ((Integer) item.getItemProperty("id").getValue() == 0){
		    	...
		    	montoProvincial.setValue("0.0");
		    	montoNacional.setValue("0.0");
		    	montoInternacional.setValue("0.0");
				tb.setSelectable(false);
	    	}
	    	...
	    	btnGraba.addClickListener(new ClickListener(){
				public void buttonClick(ClickEvent event) {
						try {
							...
							CategoriasDAO u = new CategoriasDAO();
							float num=new Formateos().convertirComaPorPunto(montoProvincial.getValue()).floatValue();
							float num1=new Formateos().convertirComaPorPunto(montoNacional.getValue()).floatValue();
							float num2=new Formateos().convertirComaPorPunto(montoInternacional.getValue()).floatValue();
							if(btnGraba.getCaption()=="Graba Nuevo"){
								try {
									 if (u.existe(nombre.getValue())==0){
										u.agrega(nombre.getValue(), descripcion.getValue(), num, num1, num2, usrLog.getId()); 
									...
									u.modifica(nombre.getValue(), descripcion.getValue(), num, num1, num2, usrLog.getId()); 		
									ini();
								}
