...
import sec.comisiones.manager.ProvinciasManager;
...
public class ProvinciasForm extends CustomComponent {

	private VerticalLayout mainLayout;
	private Panel contenedorPanel;
	private VerticalLayout verticalLayout_1;
	final ProvinciasManager tblUser = new ProvinciasManager();
	private Table tb;
	...
	public ProvinciasForm(Usuarios usr) {
		usrLog= usr;
		ini();
	}
	...
	private void ini(){
		...
		btnNew.addClickListener(new ClickListener(){
			public void buttonClick(ClickEvent event) {
				...
				ProvinciasDAO ud=new ProvinciasDAO();
...
///////////////////////////////////////////////	
	...
	class MyForm extends FormLayout {
	    ...
	    public void setItemDataSource(Item item) {
	        addComponents(nombre, descripcion, local, hl_1);
	    	...
	    	btnGraba.addClickListener(new ClickListener(){
				public void buttonClick(ClickEvent event) {
						try {
							...
							ProvinciasDAO u = new ProvinciasDAO();
							
							if(btnGraba.getCaption()=="Graba Nuevo"){
								try {
									 if (u.existe(nombre.getValue())==0){
										u.agrega(nombre.getValue(), descripcion.getValue(), local.getValue(), usrLog.getId()); 
									...
									u.modifica(nombre.getValue(), descripcion.getValue(), local.getValue(), usrLog.getId()); 		
									ini();
								}
