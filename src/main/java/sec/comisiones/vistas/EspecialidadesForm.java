...
import sec.comisiones.manager.EspecialidadesManager;
...
public class EspecialidadesForm extends CustomComponent {

	private VerticalLayout mainLayout;
	private Panel contenedorPanel;
	private VerticalLayout verticalLayout_1;
	final EspecialidadesManager tblUser = new EspecialidadesManager();
	private Table tb;
	...
	public EspecialidadesForm(Usuarios usr) {
		usrLog= usr;
		ini();
	}
	...
	private void ini(){
		...
		btnNew.addClickListener(new ClickListener(){
			public void buttonClick(ClickEvent event) {
				...
				EspecialidadesDAO ud=new EspecialidadesDAO();
	    	...
	    	btnGraba.addClickListener(new ClickListener(){
				public void buttonClick(ClickEvent event) {
						try {
							...
							EspecialidadesDAO u = new EspecialidadesDAO();
