package com.agpro.controles.infoSistema;
...
public class InfoHost {
	...
	public String toStringGeneral() {
		String json="";
		json += "\"timeInfo\":" + buildValue(getTimeInfo()) + ", ";
		json += "\"hostName\":" + buildValue(getHostName()) + ", ";
		json += "\"hostAddress\":" + buildValue(getHostAddress()) + ", ";

		json += "\"osNname\":" + buildValue(getOs().getOsNname()) + ", ";
		json += "\"osArchitecture\":" + buildValue(getOs().getOsArchitecture()) + ", ";
		json += "\"osVersion\":" + buildValue(getOs().getOsVersion()) + ", ";
		json += "\"locale\":" + buildValue(getOs().getLocale()) + ", ";
		json += "\"timeZone\":" + buildValue(getOs().getTimeZone()) + ", ";	
		
		json += "\"name\":" + buildValue(getOs().getUser().getName()) + ", ";
		json += "\"home\":" + buildValue(getOs().getUser().getHome()) + "";
